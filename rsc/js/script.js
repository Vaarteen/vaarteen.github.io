...
function updateWeather() {
    fetch("https://www.prevision-meteo.ch/services/json/toulouse")
        ...
        .then(obj => {
            ...
            document.querySelector("#day0Weather>div:last-of-type").textContent = obj.fcst_day_0.condition;
            // Météo du lendemain
            document.querySelector("#day1Weather>div:first-of-type").textContent = obj.fcst_day_1.day_long;
            let img1 = document.querySelector("#day1Weather>div>img");
            img1.src = obj.fcst_day_1.icon;
            img1.alt = obj.fcst_day_1.condition;
            document.querySelector("#day1Weather>div:last-of-type").textContent = obj.fcst_day_1.condition;
            // Météo du surlendemain
            document.querySelector("#day2Weather>div:first-of-type").textContent = obj.fcst_day_2.day_long;
            let img2 = document.querySelector("#day2Weather>div>img");
            img2.src = obj.fcst_day_2.icon;
            img2.alt = obj.fcst_day_2.condition;
            document.querySelector("#day2Weather>div:last-of-type").textContent = obj.fcst_day_2.condition;
